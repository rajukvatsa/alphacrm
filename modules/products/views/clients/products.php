...
<div class="">
    <div class="row">
        ...
        <?php echo render_select('product_categories', $product_categories, ['p_category_id', 'p_category_name'], '', '',['multiple'=>true,'data-none-selected-text'=>_l('products_categories')],[],'','',false); ?>
        </div>
