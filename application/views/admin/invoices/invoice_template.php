            ...
            <div class="col-md-<?php if (!isset($invoice_from_project)) {
                ...
                <div class="mtop10">
                    ...
                    <div class="radio radio-primary radio-inline">
                        ...
                        <label for="sq_2" style="display:none;"><?php echo _l('quantity_as_hours'); ?></label>
                    </div>
                    <div class="radio radio-primary radio-inline">
                        ...
                        <label
                            for="sq_3" style="display:none;"><?php echo _l('invoice_table_quantity_heading'); ?>/<?php echo _l('invoice_table_hours_heading'); ?></label>
                    </div>
                </div>
            </div>
        </div>
                ...
                <thead>
                  ...
                  foreach ($custom_fields as $cf) {
                     ...
                     ?>
                        ...
                        <th width="20%" align="right"><?php //echo _l('invoice_table_tax_heading'); ?>VAT</th>
