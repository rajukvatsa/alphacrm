        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="haulage_type" class="control-label">Delivery Type</label>
                        <select class="form-control" name="haulage_type" id="haulage_type" onchange="toggleHaulageCost()">
                            <option value="self_collection">Self Collection</option>
                            <option value="arranged_haulage">Arranged Haulage</option>
                        </select>
                    </div>
                    <div class="form-group" id="haulage_cost_group" style="display:none;">
                        <label for="haulage_cost" class="control-label">Arranged Haulage Cost</label>
                        <input type="number" step="0.01" class="form-control" name="haulage_cost" id="haulage_cost">
                    </div>
...
<?php echo form_close(); ?>
<script>
function toggleHaulageCost() {
    var haulageType = $('#haulage_type').val();
    if (haulageType === 'arranged_haulage') {
        $('#haulage_cost_group').show();
    } else {
        $('#haulage_cost_group').hide();
        $('#haulage_cost').val('');
    }
}
