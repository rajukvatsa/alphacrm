                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     ?>
                        ...
                        <li style="display:none;" <?php if ($disable_convert) {
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab_proposal">
                     ...
                     if (count($proposal->attachments) > 0) { ?>
                        ...
                        <div class="panel_s mtop15">
                            <div class="panel-body">
                                <h4><?php echo _l('payment_details'); ?></h4>
                                <?php 
                                $this->load->model('payment_modes_model');
                                $payment_modes = $this->payment_modes_model->get('', [], false);
                                if (!empty($payment_modes)) {
                                    foreach ($payment_modes as $mode) {
                                        if (isset($mode['show_on_pdf']) && $mode['show_on_pdf'] == 1 && !empty($mode['description'])) {
                                            echo '<div class="bank-detail-item">';
                                            echo '<strong>' . e($mode['name']) . ':</strong><br />';
                                            echo $mode['description'];
                                            echo '</div><br />';
                                        }
                                    }
                                } else {
                                    echo '<p class="text-muted">' . _l('no_payment_modes_found') . '</p>';
                                }
                                ?>
                            </div>
                        </div>
