...
$aColumns = array_merge($aColumns, [
	...
	db_prefix() . 'items_warehouse.name as warehouse_name',
    ]);
...
$join = [
	...
	'LEFT JOIN ' . db_prefix() . 'items_warehouse ON ' . db_prefix() . 'items_warehouse.id = ' . db_prefix() . 'items.warehouse_id',
    ];
$additionalSelect = [
    db_prefix() . 'items.id',
