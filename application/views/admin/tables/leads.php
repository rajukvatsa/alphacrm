...
return App_table::find('leads')
    ->outputUsing(function ($params) use ($statuses) {
       ...
       $where[]='AND ('.db_prefix().'leads.date_converted IS NULL)';
        ...
        foreach ($rResult as $aRow) {
            ...
            $row[] = '<span data-toggle="tooltip" data-title="' . e(time_ago($aRow['dateadded'])) . '" class="text-has-action is-date">' . e(_dt($aRow['dateadded'])) .'</span>';
