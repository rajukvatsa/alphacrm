...
function get_dashboard_widgets()
{
    $widgets = [
        ...
        [
            'path'      => 'admin/dashboard/widgets/pending_invoices_filter',
            'container' => 'top-12',
        ],
        [
            'path'      => 'admin/dashboard/widgets/payment_totals',
            'container' => 'left-8',
        ],
        [
            'path'      => 'admin/dashboard/widgets/stock_manager',
            'container' => 'left-8',
        ],
        [
            'path'      => 'admin/dashboard/widgets/item_groups_stock',
            'container' => 'right-4',
        ],
    ];
